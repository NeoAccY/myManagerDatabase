...
$response3 = '';
    ...
    if(isset($_POST['Execute'])){
        ...
        $result = mysqli_query($conexion, $sql);
        if($result){
            $response1 =  '<h5>Alter table con exito...</h5>';
            $response2 =  nl2br($sql).'<br><br>';
        }else{
            $response3= "<br>Alter table error: Ingrese una consulta SQL valida ->".mysqli_error($conexion);
        }
    }
    if(isset($_POST['Execute'])){
        $bd = $_POST['data'];
...
<body>
    <form action="" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
        ...
        <div class="title-cards">
            <h2 style="color:red">Alter Table</h2>
        </div>
        <div class="container-card">
            ...
            <div class="card">
                ...
                <div class="contenido-card">
                    ...
                    <br><label for="">Alter table: <?php echo $table ?></label>
